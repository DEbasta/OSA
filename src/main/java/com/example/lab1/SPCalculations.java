...
public class SPCalculations {
    ...
    double [] SumHA = new double[N], ProizHA = new double[N], LuisHA = new double[N], SumHB = new double[N], ProizHB = new double[N], LuisHB = new double[N],  tmpSum1 = new double[N], tmpSum2 = new double[N], tmpSum = new double[N], FactH = new double[N];
    ...
    public double[] getCorrellArray(){
        double [] correlArray = new double[10];
        correlArray[0] = coefCorrel(RanksF,RanksF);
        correlArray[1] = coefCorrel(RanksF,RanksSHA);
        correlArray[2] = coefCorrel(RanksF,RanksPHA);
        correlArray[3] = coefCorrel(RanksF,RanksLHA);
        correlArray[4] = coefCorrel(RanksF,RanksAvgA);
        correlArray[5] = coefCorrel(RanksF,RanksSHB);
        correlArray[6] = coefCorrel(RanksF,RanksPHB);
        correlArray[7] = coefCorrel(RanksF,RanksLHB);
        correlArray[8] = coefCorrel(RanksF,RanksAvgB);
        correlArray[9] = coefCorrel(RanksF,RanksAvg);
        return correlArray;
    }

    public ArrayList<Double> getLeftCuts() {
        return LeftCuts;
    }

    public ArrayList<Double> getRightCuts() {
        return RightCuts;
    }

    public double[] getFactH(){
        return FactH;
    }
    public double[] getSumHA(){
        return SumHA;
    }
    public double[] getProizHA(){
        return ProizHA;
    }
    public double[] getLuisHA(){
        return LuisHA;
    }
    public double[] getSumHB(){
        return SumHB;
    }
    public double[] getProizHB(){
        return ProizHB;
    }
    public double[] getLuisHB(){
        return LuisHB;
    }

    public double[] getRanksF(){
        return RanksF;
    }
    public double[] getRanksSHA(){
        return RanksSHA;
    }

    public double[] getRanksPHA(){
        return RanksPHA;
    }

    public double[] getRanksLHA(){
        return RanksLHA;
    }

    public double[] getRanksSHB(){
        return RanksSHB;
    }

    public double[] getRanksPHB(){
        return RanksPHB;
    }

    public double[] getRanksLHB(){
        return RanksLHB;
    }

    public double[] getRanksAvgA(){
        return RanksAvgA;
    }

    public double[] getRanksAvgB(){
        return RanksAvgB;
    }
